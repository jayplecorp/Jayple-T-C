...
export default function AboutHero() {
  return (
    <section className="relative min-h-[60vh] flex items-center bg-hero-gradient pt-28 pb-16 overflow-hidden">
      {/* Background ambient grid and subtle radial highlight */}
      <div 
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10">
        ...
        <div className="max-w-5xl">
          ...
          >
            Jayple started with a question about an everyday salon experience.
          </motion.h1>
