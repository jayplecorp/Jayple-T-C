    ...
    <div className={`flex flex-wrap items-center gap-3.5 ${className}`}>
      ...
      {hasAndroid && (
        <a
          ...
          className="flex items-center flex-nowrap shrink-0 gap-3 bg-white/08 border border-white/15 hover:bg-white/14 px-5 py-2.5 rounded-xl transition-all duration-200 hover:-translate-y-0.5"
        ...
        >
          ...
          <span className="text-left leading-tight shrink-0">
            <span className="block text-[9px] text-text-on-dark-muted font-medium uppercase tracking-wider whitespace-nowrap">GET IT ON</span>
            <span className="block text-xs font-bold text-white whitespace-nowrap">Google Play</span>
          </span>
        </a>
      )}
      ...
      {hasIos && (
        ...
        >
          ...
          <span className="text-left leading-tight shrink-0">
            <span className="block text-[9px] text-text-on-dark-muted font-medium uppercase tracking-wider whitespace-nowrap">Download on the</span>
            <span className="block text-xs font-bold text-white whitespace-nowrap">App Store</span>
          </span>
        </a>
      )}
    </div>
